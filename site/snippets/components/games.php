      ...
      <?php if ($isFeatured): ?>
        ...
        <div
          class="
            ...
            md:grid md:grid-cols-2 md:items-center md:gap-5xl md:p-5xl
            md:group-hover:translate-[-4px] md:group-hover:z-2 md:group-active:translate-0
          "
        >
          <?php if ($logo): ?>
            ...
            >
              ...
              <span
                class="
                  ...
                  group-hover:opacity-100 group-hover:ml-2 motion-reduce:transition-none
                "
                aria-hidden="true"
              ></span>
            </a>
      ...
      <?php else: ?>
        <div
          class="
            ...
            md:p-5xl md:group-hover:translate-[-4px] md:group-active:translate-0
          "
        >
          <?php if ($logo): ?>
            <figure class="mb-4xl">
            ...
            >
              ...
              <span
                class="
                  ...
                  ml-1
                  opacity-0 -translate-y-1/2 transition-[opacity,margin]
                  group-hover:opacity-100 group-hover:ml-3 motion-reduce:transition-none
                "
                aria-hidden="true"
              ></span>
            </a>
