...
<ul class="grid md:grid-cols-2 md:[&>li:nth-child(even)>*]:mr-[-2px]">
  ...
  <?php foreach ($items as $game): ?>
    ...
    >
      <?php if ($isFeatured): ?>
        <div class="relative bg-white border-2 border-primary-700 p-3xl md:p-5xl md:grid md:grid-cols-2 md:gap-5xl md:items-center transition-transform duration-200 md:group-hover:translate-[-4px] md:group-active:translate-0">
          <?php if ($logo): ?>
